...
// NatCubic_SplineGrowth_loglike_cubicspline_extrasero
...
RcppExport SEXP _COVIDCurve_NatCubic_SplineGrowth_loglike_cubicspline_extrasero(SEXP paramsSEXP, SEXP param_iSEXP, SEXP dataSEXP, SEXP miscSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type params(paramsSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::List >::type data(dataSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type misc(miscSEXP);
    rcpp_result_gen = Rcpp::wrap(NatCubic_SplineGrowth_loglike_cubicspline_extrasero(params, param_i, data, misc));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_COVIDCurve_NatCubic_SplineGrowth_loglike_cubicspline_extrasero", (DL_FUNC) &_COVIDCurve_NatCubic_SplineGrowth_loglike_cubicspline_extrasero, 4},
    {NULL, NULL, 0}
};
