...
# Make Model
#..............................................................
df_params <- tibble::tibble(name = c("ma1", "ma2", paste0("y", 1:6)),
                            min = c(0, 0, rep(0, 6)),
                            max = c(1, 1, rep(10, 6)),
                            init = c(0.1, 0.4, rep(4, 6)),
                            dsc1 = c(100, 500, rep(3, 6)),
                            dsc2 = c(900, 500, rep(5, 6)))

mod1 <- make_modinf$new()
mod1$set_level("Time-Series")
mod1$set_data(dat)
mod1$set_IFRparams(c("ma1", "ma2"))
mod1$set_Infxnparams(c("y1", "y2", "y3", "y4", "y5", "y6"))
mod1$set_paramdf(df_params)
mod1$set_pa(c(0.5, 0.5))
...
r_mcmc_out <- COVIDCurve::run_modinf(modinf = mod1, reparamIFR = F)
r_mcmc_out
